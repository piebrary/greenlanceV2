...
;(async () => {
    ...
    try {
        ...
        await fs.cp('./lib/api/default', '../../../api/default', { recursive: true })
        await fs.cp('./lib/api/.env.example', '../../../api/.env.example')
        await fs.cp('./lib/app/.env.example', '../../../app/.env.example')
        await fs.cp('./lib/app/src/default', '../../../app/src/default', { recursive: true })
        await fs.cp('./lib/documentation/default', '../../../documentation/default', { recursive: true })
        await fs.cp('./lib/scripts/default', '../../../scripts/default', { recursive: true })
