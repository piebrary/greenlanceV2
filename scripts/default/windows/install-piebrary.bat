...
set /p "API_ENABLE_PUBLIC_REGISTRATION=Boolean enable users to register themselfs [%API_ENABLE_PUBLIC_REGISTRATION%] : "
...
echo API_ENABLE_PUBLIC_REGISTRATION >> ../api/.env
